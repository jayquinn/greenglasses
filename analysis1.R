...
#### 알파 분석 ####
alpha(dat[c(262:278,280)]) #가격정보 .66 제외:279
alpha(dat[c(63:66,68:70,191,210,218,219,224)]) #감정 .79 제외:67
alpha(dat[c(359,373,374,385,347,361)])#개방 .63
alpha(dat[c(83:87,99)]) #개방가치 -.08
...
alpha(dat[c(40:56,59:62)])#미적정서 .87 제외:39
